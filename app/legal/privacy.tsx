  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#F5F7FA" }}>
      ...
      >
        ...
        <SectionCard title={t("privacyDataCollectedTitle")} body={t("privacyDataCollectedBody")} />
        <SectionCard title={t("privacyHowUsedTitle")} body={t("privacyHowUsedBody")} />
        <SectionCard title={t("privacyNoSaleTitle")} body={t("privacyNoSaleBody")} />
        <SectionCard title={t("privacyDeletionTitle")} body={t("privacyDeletionBody")} />
        <SectionCard title={t("privacyContactTitle")} body={t("privacyContactBody")} />
